...
export const AddClientModal: React.FC<AddClientModalProps> = ({ visible, onClose, onSuccess }) => {
  ...
  const handleAddClient = async () => {
    ...
    try {
      ...
      if (response.data?.isSuccess) {
        AppAlertStatic.alert('Success', 'Client added successfully!');
        ...
        AppAlertStatic.alert('Error', response.data?.message || 'Failed to add client');
      }
    } catch (err: any) {
    ...
    <Modal visible={visible} animationType="slide" presentationStyle="pageSheet">
      ...
      <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={styles.modalContainer}>
        <ScrollView contentContainerStyle={styles.modalContent}>
          ...
          <TouchableOpacity style={styles.submitBtn} onPress={handleAddClient} disabled={submitting}>
            {submitting ? <ActivityIndicator color="#fff" /> : <Text style={styles.submitBtnText}>Save Client</Text>}
          </TouchableOpacity>
        </ScrollView>
